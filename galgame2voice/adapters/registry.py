...
PROVIDER_PRESETS: Dict[str, Dict[str, Any]] = {
    ...
    "openai": {
        ...
        "preset_models": ["gpt-4o", "gpt-4o-mini", "o3-mini", "o1", "gpt-4-turbo"],
        "description": "OpenAI 官方 API (GPT-4o, Whisper)",
    },
    "deepseek": {
        "id": "deepseek",
        "name": "DeepSeek",
    ...
    "anthropic": {
        ...
        "description": "Anthropic 官方 Claude 原生 Messages API",
    },
    "xai": {
        "id": "xai",
        "name": "xAI (Grok)",
        "default_base_url": "https://api.x.ai/v1",
        "default_chat_model": "grok-2",
        "default_stt_model": "",
        "adapter_class": XAILLMAdapter,
        "stt_adapter_class": None,
        "preset_models": ["grok-2", "grok-2-vision", "grok-beta", "grok-vision-beta"],
    ...
    "glm": {
        ...
        "stt_adapter_class": None,
        "preset_models": ["glm-4-plus", "glm-4-flash", "glm-4-air", "glm-4-long", "glm-4v-plus"],
        "description": "智谱 BigModel 开放平台 GLM-4 旗舰系列",
    },
    "qwen": {
        "id": "qwen",
        "name": "通义千问 (Qwen)",
        ...
        "description": "阿里云百炼 DashScope 通义千问大模型与语音识别",
    },
    "custom": {
        "id": "custom",
        ...
        "stt_adapter_class": OpenAICompatibleSTTAdapter,
        "preset_models": ["llama3.3", "qwen2.5", "deepseek-r1", "custom-model"],
